// components/GalleryTunnelPreloader.tsx
"use client";
...
/**
 * Your logos, served from /public.
 * Files with spaces in the name work fine in Next.js — the browser
 * URL-encodes them automatically when the texture loader fetches them.
 */
...
interface GalleryTunnelPreloaderProps {
  ...
  style?: CSSProperties;
  /** Fired on every pointer press — handy for "press to skip" logic in a parent. */
  onPress?: () => void;
}
...
export default function GalleryTunnelPreloader(
  props: GalleryTunnelPreloaderProps,
) {
  const {
    images,
    colors,
  ...
  }, [urls, palette, background, lineColor, lineOpacity, grid, fade, onPress]);
