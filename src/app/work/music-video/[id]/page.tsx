...
const PROJECT = {
  ...
  description:
    "Stylized rhythm and light. A music visualizer combining high contrast desert landscapes with synchronized performance cuts.",
  gallery: [
    { id: 1, src: "https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=1600&auto=format&fit=crop" },
    ...
    { id: 9, src: "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?q=80&w=1200&auto=format&fit=crop" },
  ],
};
